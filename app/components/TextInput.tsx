      ...
      <>
        ...
        <p className="flex flex-row">
          ...
          <input
            ...
            required={required}
            inputMode={inputMode}
            className="w-full rounded-md rounded-l-none border-l-0 focus:border-night-700 focus:outline-none focus:ring-0 dark:bg-night-700 dark:text-day-100 dark:focus:border-day-100"
            {...rest}
          />
        </p>
      </>
  ...
  return (
    <>
      ...
      <input
        ...
        required={required}
        inputMode={inputMode}
        className="rounded-md focus:border-night-700 focus:outline-none focus:ring-0 dark:bg-night-700 dark:text-day-100 dark:focus:border-day-100"
        {...rest}
      />
    </>
  );
